...
hospitalizations_exp_1994_2007 <- hospitalizations_1994_2017 %>%
 ...
 filter(grepl("^E10", ZDG) | 
         ...
         grepl("^E10", DDG4) | 
         grepl("^E10", DDG5)) %>%
 filter((VEK == 0 & year(ymd(DATPRI)) == 1994) |
         (VEK <= 1 & year(ymd(DATPRI)) == 1995) |
         (VEK <= 2 & year(ymd(DATPRI)) == 1996) |
         (VEK <= 3 & year(ymd(DATPRI)) == 1997) |
         (VEK <= 4 & year(ymd(DATPRI)) == 1998) |
         (VEK <= 5 & year(ymd(DATPRI)) == 1999) |
         (VEK <= 6 & year(ymd(DATPRI)) == 2000) |
         (VEK <= 7 & year(ymd(DATPRI)) == 2001) |
         (VEK <= 8 & year(ymd(DATPRI)) == 2002) |
         (VEK <= 9 & year(ymd(DATPRI)) == 2003) |
         (VEK <= 10 & year(ymd(DATPRI)) == 2004) |
         (VEK <= 11 & year(ymd(DATPRI)) == 2005) |
         (VEK <= 12 & year(ymd(DATPRI)) == 2006) |
         (VEK <= 13 & year(ymd(DATPRI)) == 2007))
...
save(data_models, 
     file = "path/Data/Data_models/data_models_exact_matching_w_mortality_incident.RData")
